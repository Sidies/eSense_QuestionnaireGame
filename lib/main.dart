...
class QuestionnaireApp extends StatelessWidget {
  ...
  static void storeThemeData(int index) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setInt("colorTheme", index);
  }

  void getAndSetThemeData() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    ...
    if(prefs.getInt("colorTheme") == -1) {
      // use standard theme
      greenTheme();
    }
    else {
      int index = prefs.getInt("colorTheme");
